...
export default function ChatList() {
  ...
  return (
    <div className={`${currentChatId ? 'hidden sm:block ml-[10vw]' : ''} md:w-1/3 md:ml-[12vw] bg-laccent dark:bg-daccent rounded-[6px] h-[calc(100vh-16rem)] overflow-y-auto mt-[100px] bg-laccent border-[4px] border-dark rounded-[6px] dark:bg-daccent dark:border-[4px] dark:border-light dark:border-opacity-5 border-opacity-5 w-[90vw] mx-auto`}>
